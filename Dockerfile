...
RUN dpkg -i $TOC_CHROME_BUNDLE_NAME; \
  ...
  tar -xzf $TOC_BUNDLE_PATH/$TOC_PLATFORMS_BUNDLE_NAME && \
  rm $TOC_PLATFORMS_BUNDLE_NAME && \
  tar -xzf $TOC_BUNDLE_PATH/$TOC_PLUGINS_BUNDLE_NAME && \
  rm $TOC_PLUGINS_BUNDLE_NAME && \
  tar -xzf $TOC_BUNDLE_PATH/$TOC_ENGINE_BUNDLE_NAME && \
